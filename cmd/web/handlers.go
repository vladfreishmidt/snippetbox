...
import (
	...
	"github.com/vladfreishmidt/snippetbox/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionsManager.Put(r.Context(), "flash", "Your signup was successful. Please log in.")
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionsManager.Put(r.Context(), "flash", "You've been logged out successfully!")
